...
class __TwigTemplate_d9c9d0fe6eda80770bd47e18e0eb88566f463f092ff8b53114fe6ddd4b4b1d6f extends Twig_Template
{
...
";
    ...
    public function block_contents($context, array $blocks = array())
    {
        ...
        echo $this->getAttribute(($context["field"] ?? null), "name", array());
        echo "\">
            <label for=\"";
        // line 18
        if ($this->getAttribute(($context["field"] ?? null), "id", array(), "any", true, true)) {
            ...
            echo twig_escape_filter($this->env, $this->getAttribute(($context["field"] ?? null), "name", array()));
        }
        echo "\" class=\"sr-only\">";
    ...
    public function block_input($context, array $blocks = array())
    {
        ...
        echo "\"
                        value=\"";
        // line 24
        echo twig_join_filter(twig_escape_filter($this->env, ($context["value"] ?? null), "html_attr"), ", ");
        echo "\"
                        ";
        // line 26
        echo "                        ";
    ...
    public function block_input_attributes($context, array $blocks = array())
    {
        ...
        if ($this->getAttribute($this->getAttribute(($context["field"] ?? null), "validate", array()), "message", array())) {
            echo "title=\"";
            echo $this->env->getExtension('Grav\Common\Twig\TwigExtension')->translate(twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["field"] ?? null), "validate", array()), "message", array())));
            echo "\"
                            ";
        } elseif ($this->getAttribute(        // line 39
($context["field"] ?? null), "title", array(), "any", true, true)) {
            echo "title=\"";
            echo $this->env->getExtension('Grav\Common\Twig\TwigExtension')->translate(twig_escape_filter($this->env, $this->getAttribute(($context["field"] ?? null), "title", array())));
            echo "\" ";
        }
        // line 40
        echo "                        ";
...
{% block field %}
    ...
    {% endblock %}
{% endblock %}
", "forms/field.html.twig", "/var/www/public/mache/user/themes/mache/templates/forms/field.html.twig");
    }
}
