...
return [
    ...
    'timestamp' => 1537712504,
    'checksum' => '3096a23811ab0f009e8d98dd70bd8414',
    'files' => [
        'user/config' => [
            'media' => [
    ...
    'data' => [
        'plugins' => [
            'admin' => [
                ...
                'pagemedia' => [
                    ...
                    'res_max_width' => 0,
                    'res_max_height' => 0,
                    'resize_quality' => 0.80000000000000004
                ]
            ],
            'email' => [
                'enabled' => true,
            ...
            'form' => [
                ...
                'recaptcha' => [
                    'site_key' => '6LeZWmYUAAAAAGXWdMuDwEiSyS0AQCIHYSjs1w_5',
                    'secret_key' => '6LeZWmYUAAAAAPofVRaRwELabHM8cm27ZfCgiKeS'
                ]
            ],
            'login' => [
                'enabled' => true,
        ...
        'themes' => [
            'mache' => [
                'enabled' => true,
                'left_footer' => '#### © 2018 COPYRIGHT JOHN JURC
...
',
                ...
                'favicon' => [
                    'user/themes/mache/images/favicon.ico' => [
                        'name' => 'favicon.ico',
                        'type' => 'image/x-icon',
                        'size' => 318,
                        'path' => 'user/themes/mache/images/favicon.ico'
                    ]
                ],
                'logo' => [
                    'user/themes/mache/images/fortinet2-1.png' => [
                        'name' => 'fortinet2-1.png',
                        'type' => 'image/png',
                        'size' => 10030,
                        'path' => 'user/themes/mache/images/fortinet2-1.png'
                    ]
                ]
            ]
        ]
